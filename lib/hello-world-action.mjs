...
var import_tunnel, import_undici, __awaiter$9, HttpCodes, Headers, MediaTypes, HttpRedirectCodes, HttpResponseRetryCodes;
var init_lib = __esmMin((() => {
	import_tunnel = /* @__PURE__ */ __toESM(require_tunnel(), 1);
	import_undici = require_undici();
	__awaiter$9 = void 0 && (void 0).__awaiter || function(thisArg, _arguments, P, generator) {
...
var init_auth = __esmMin((() => {
	__awaiter$8 = void 0 && (void 0).__awaiter || function(thisArg, _arguments, P, generator) {
		function adopt(value) {
			return value instanceof P ? value : new P(function(resolve) {
				resolve(value);
			});
...
var init_oidc_utils = __esmMin((() => {
	...
	init_auth();
	init_core();
	__awaiter$7 = void 0 && (void 0).__awaiter || function(thisArg, _arguments, P, generator) {
		function adopt(value) {
			return value instanceof P ? value : new P(function(resolve) {
				resolve(value);
			});
...
var __awaiter$6, access, appendFile, writeFile, SUMMARY_ENV_VAR, Summary, _summary;
var init_summary = __esmMin((() => {
	__awaiter$6 = void 0 && (void 0).__awaiter || function(thisArg, _arguments, P, generator) {
		function adopt(value) {
			return value instanceof P ? value : new P(function(resolve) {
				resolve(value);
			});
...
var __awaiter$5, chmod, copyFile, lstat, mkdir, open, readdir, rename, rm, rmdir, stat, symlink, unlink, IS_WINDOWS$1, READONLY;
var init_io_util = __esmMin((() => {
	__awaiter$5 = void 0 && (void 0).__awaiter || function(thisArg, _arguments, P, generator) {
		function adopt(value) {
			return value instanceof P ? value : new P(function(resolve) {
				resolve(value);
			});
...
var init_io = __esmMin((() => {
	init_io_util();
	__awaiter$4 = void 0 && (void 0).__awaiter || function(thisArg, _arguments, P, generator) {
		function adopt(value) {
			return value instanceof P ? value : new P(function(resolve) {
				resolve(value);
			});
...
function getInput(name, options) {
	...
	console.log("val", `INPUT_${name.replace(/ /g, "_").toUpperCase()}`);
...
//#endregion
//#region src/hello-world-action.ts
var require_hello_world_action = /* @__PURE__ */ __commonJSMin((() => {
	init_core();
	init_test();
	function run() {
		try {
...
//#endregion
export default require_hello_world_action();
